...
const createLogs_1 = require("./createLogs");
...
const spreadData = async (req, res, next) => {
    ...
    if (!fullText) {
        ...
        const [userData] = await connect.query("SELECT userName FROM Users WHERE id = ?", [req.user.id]);
        const user = userData[0];
        // log the action
        await (0, createLogs_1.auditLog)({
...
//# sourceMappingURL=structureQuestion.js.map